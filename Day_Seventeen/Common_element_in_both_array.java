...
public class Common_element_in_both_array {

    public static void Common_element_in_both_array(ArrayList<Integer> first, ArrayList<Integer> Second, int n,
            int in) {
    ...
    public static void main(String[] args) {
        ...
        Common_element_in_both_array(first, Second, n, in);
