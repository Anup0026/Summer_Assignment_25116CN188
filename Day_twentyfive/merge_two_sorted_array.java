...
public class merge_two_sorted_array {
    ...
    public static void merge_array(ArrayList<Integer> first, ArrayList<Integer> Second, int n, int in) {
        ...
        System.out.println("Sorted  Array has been merged :");
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter the sorted element in the first array :");
        for (int i = 0; i < n; i++) {
        ...
        int in = sc.nextInt();
        System.out.println("Enter the sorted element in the Second array :");
        for (int j = 0; j < in; j++) {
